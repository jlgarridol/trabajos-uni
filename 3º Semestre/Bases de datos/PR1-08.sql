...
CREATE TABLE articulo (
	...
	cod_Articulo integer CONSTRAINT NN_cod_Articulo NOT NULL,
	CONSTRAINT PK_cod_Articulo PRIMARY KEY (cod_Articulo),	
	cod_Armario integer CONSTRAINT NN_cod_Armario NOT NULL,
	CONSTRAINT UNQ_Seccion_Armario UNIQUE (cod_Seccion, cod_Armario),
	existencias integer CONSTRAINT NN_existencias NOT NULL,
